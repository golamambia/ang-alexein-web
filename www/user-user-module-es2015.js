...
UserModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_3__["NgModule"])({
        imports: [
            ...
            _user_routing_module__WEBPACK_IMPORTED_MODULE_4__["BaseRoutingModule"],
...
const routes = [
    {
        ...
        children: [
            ...
            {
                path: 'dashboard',
                loadChildren: () => __webpack_require__.e(/*! import() | user-dashboard-user-dashboard-module */ "user-dashboard-user-dashboard-module").then(__webpack_require__.bind(null, /*! ./user-dashboard/user-dashboard.module */ "R15X")).then(m => m.UserDashboardPageModule),
            },
            {
                path: 'profile',
                loadChildren: () => __webpack_require__.e(/*! import() | user-profile-user-profile-module */ "user-profile-user-profile-module").then(__webpack_require__.bind(null, /*! ./user-profile/user-profile.module */ "22df")).then(m => m.UserProfilePageModule)
            },
            {
                path: 'bid-report',
                loadChildren: () => __webpack_require__.e(/*! import() | user-bid-report-user-bid-report-module */ "user-bid-report-user-bid-report-module").then(__webpack_require__.bind(null, /*! ./user-bid-report/user-bid-report.module */ "k8Z8")).then(m => m.UserBidReportPageModule)
            },
        ]
    }
];
