(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["seller-seller-profile-seller-profile-module"], {
    /***/
    "1rE7":
    /*!****************************************************************!*\
      !*** ./src/app/seller/seller-profile/seller-profile.module.ts ***!
      \****************************************************************/

    /*! exports provided: SellerProfilePageModule */

    /***/
    function rE7(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    "Il2L":
    /*!****************************************************************!*\
      !*** ./src/app/seller/seller-profile/seller-profile.page.scss ***!
      \****************************************************************/

    /*! exports provided: default */

    /***/
    function Il2L(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    "Y02S":
    /*!**************************************************************!*\
      !*** ./src/app/seller/seller-profile/seller-profile.page.ts ***!
      \**************************************************************/

    /*! exports provided: SellerProfilePage */

    /***/
    function Y02S(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      var SellerProfilePage = /*#__PURE__*/function () {
        ...
        _createClass(SellerProfilePage, [{
          ...
          value: function getUserDetails() {
            ...
            this.storage.get('auctionSeller').then(function (response) {
              ...
              if (response && response.response_data && response.response_data.id) {
                _this2.selleId = response.response_data.id;
          ...
          value: function getUserData() {
            ...
            formData.append('user_id', this.selleId); // formData.append('password', this.loginForm.value.password);

            this.http.post(this.url + 'user-details', formData).subscribe(function (res) {
              _this3.loadingHide(); // console.log(res);


              if (res && res.status) {
                _this3.buyerData = res.response_data;
                _this3.name = res.response_data.name;
                _this3.email = res.response_data.email;
                ...
                try {
                  for (_iterator.s(); !(_step = _iterator.n()).done;) {
                    ...
                    if (rd['meta_key'] == 'billing_address') {
                      _this3.billing_address = rd['meta_value'];
                    }

                    if (rd['meta_key'] == 'country') {
                      _this3.country = rd['meta_value'];
                    }

                    if (rd['meta_key'] == 'state') {
                      _this3.state = rd['meta_value'];
                    }

                    if (rd['meta_key'] == 'city') {
                      _this3.city = rd['meta_value'];
                    }

                    if (rd['meta_key'] == 'zip') {
                      _this3.zip = rd['meta_value'];
                    }
                    ...
                    if (rd['meta_key'] == 'dob') {
                      ...
                      _this3.dob = rd['meta_value'];
                    }

                    if (rd['meta_key'] == 'phone_no') {
                      _this3.phone_no = rd['meta_value'];
                    }
                  } // 
          ...
          value: function onSubmit() {
            ...
            formData.append('user_id', this.selleId);
            this.http.post(this.url + 'user-update', formData).subscribe(function (res) {
              ...
              if (res && res.status) {
                ...
                _this4.presentAlert('Error!', '', res.message);
              }
            }, function (err) {
              _this4.loadingHide();
    ...
    "r+C9":
    /*!******************************************************************************************************!*\
      !*** ./node_modules/raw-loader/dist/cjs.js!./src/app/seller/seller-profile/seller-profile.page.html ***!
      \******************************************************************************************************/

    /*! exports provided: default */

    /***/
    function rC9(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    "zgED":
    /*!************************************************************************!*\
      !*** ./src/app/seller/seller-profile/seller-profile-routing.module.ts ***!
      \************************************************************************/

    /*! exports provided: SellerProfilePageRoutingModule */

    /***/
    function zgED(module, __webpack_exports__, __webpack_require__) {
      "use strict";
...
//# sourceMappingURL=seller-seller-profile-seller-profile-module-es5.js.map