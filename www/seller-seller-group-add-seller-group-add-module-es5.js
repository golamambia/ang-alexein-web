(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["seller-seller-group-add-seller-group-add-module"], {
    ...
    /***/
    function t8D(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function Cyr(module, __webpack_exports__, __webpack_require__) {
      "use strict";
        ...
        _createClass(SellerGroupAddPage, [{
          ...
          value: function getGroupById(id) {
            ...
            this.http.post(this.url + 'group-details', formData).subscribe(function (res) {
              ...
              _this2.titleText = 'Update Group';
              _this2.titleText1 = 'Update group';

              _this2.groupForm.patchValue(res.response_data);

              _this2.groupForm.patchValue({
              ...
              if (this.id) {
                ...
                this.http.post(this.url + 'group-update', formData).subscribe(function (res) {
                  ...
                  if (res.status) {
                    ...
                    _this4.presentAlert('Success!', '', res.message ? res.message : 'Seccessfully updated.');
                  } else {
                ...
                this.http.post(this.url + 'group-add', formData).subscribe(function (res) {
                  ...
                  if (res.status) {
                    _this4.groupForm.reset();

                    _this4.submitted = false;

                    _this4.presentAlert('Success!', '', res.message ? res.message : 'Seccessfully added.');
                  } else {
                    _this4.presentAlert('Error!', '', 'Server error, please try again later');
                  }
                }, function (err) {
    ...
    /***/
    function D1Ad(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function Kb9F(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function hJ1(module, __webpack_exports__, __webpack_require__) {
      "use strict";
