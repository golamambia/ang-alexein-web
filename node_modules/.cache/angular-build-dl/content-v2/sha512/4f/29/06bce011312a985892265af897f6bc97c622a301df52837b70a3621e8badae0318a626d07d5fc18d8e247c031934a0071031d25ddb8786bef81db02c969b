(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["product-details-product-details-module"], {
    ...
    /***/
    function Oez0(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function SqMz(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function dmuU(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function fLsq(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function iSGO(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      var ProductDetailsPage = /*#__PURE__*/function () {
        function ProductDetailsPage(modalService, alertController, formBuilder, http, loadingController, storage, router, route) {
        ...
        _createClass(ProductDetailsPage, [{
                    ...
                    case 2:
                      this.sub = this.route.params.subscribe(function (params) {
                        if (params) {
                          ...
                          if (params['id']) {
                            _this.getProductById(params['id']); //this.getMultiImage();
          ...
          value: function triggerModal(content) {
            ...
            this.modalService.open(content, {
              ...
              _this3.closeModal = "Closed with: ".concat(res);
            }, function (res) {
              _this3.closeModal = "Dismissed ".concat(_this3.getDismissReason(res));
            });
          }
        }, {
            ...
            if (this.buyerId) {
              this.http.post(this.url + 'bid-add', formData).subscribe(function (res) {
                ...
                if (res.status == true) {
                  ...
                  _this4.presentAlert('Success!', '', res.message); //this.dataList();
