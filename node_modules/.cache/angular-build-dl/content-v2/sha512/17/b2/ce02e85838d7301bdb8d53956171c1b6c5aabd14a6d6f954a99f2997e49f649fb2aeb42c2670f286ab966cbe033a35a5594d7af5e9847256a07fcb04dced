(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["group-details-product-details-module"], {
    /***/
    "+s0g":
    /*!******************************************!*\
    ...
    "1ijR":
    /*!*********************************************************!*\
      !*** ./src/app/group-details/product-details.page.scss ***!
      \*********************************************************/

    /*! exports provided: default */

    /***/
    function ijR(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    "5yP0":
    /*!*******************************************************!*\
      !*** ./src/app/group-details/product-details.page.ts ***!
      \*******************************************************/

    /*! exports provided: ProductDetailsPage */

    /***/
    function yP0(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      var _raw_loader_product_details_page_html__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      /*! raw-loader!./product-details.page.html */
      "VHd7");
      /* harmony import */


      var _product_details_page_scss__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
      ...
      var ProductDetailsPage = /*#__PURE__*/function () {
        function ProductDetailsPage(modalService, alertController, formBuilder, navCtrl, http, loadingController, storage, router, route) {
        ...
        _createClass(ProductDetailsPage, [{
                    ...
                    case 2:
                      this.sub = this.route.params.subscribe(function (params) {
                        if (params) {
                          ...
                          if (params['id']) {
                            _this.getProductById(params['id']); // this.getProductBid(params['id']);
                      ...
                      this.storage.get('auctionUser').then(function (response) {
                        ...
                        if (response && response.response_data && response.response_data.id) {
                          _this.buyerId = response.response_data.id; // this.buyerData=response.response_data;
                        } else {
                          _this.buyerId = null;
                        }
                      }, function (err) {
          ...
          key: "time_count",
          value: function time_count(countDownDate1) {
            var countDownDate = new Date(countDownDate1).getTime(); // Update the count down every 1 second
            ...
            var x = setInterval(function () {
              ...
              var seconds = Math.floor(distance % (1000 * 60) / 1000); //console.log(now, "now", "countDownDate", countDownDate, "distance", distance, "days", days);
          ...
          value: function getProductById(id) {
            ...
            this.http.post(this.url + 'group-details', formData).subscribe(function (res) {
              if (res.status) {
                console.log(res); //this.loadingHide();

                _this2.itemTotal = res.group_item_total_count;
                var countDownDate1 = new Date("Jun 10, 2021 22:05").getTime();
                var m = moment__WEBPACK_IMPORTED_MODULE_11__(res.response_data.end_date, "YYYY-MM-DD").format('MMM D, YYYY') + ' ' + res.response_data.end_time;

                _this2.time_count(m); //console.log(m);


                _this2.product_deltail = res.response_data;
              } else {
                //this.loadingHide();
                _this2.presentAlert('Error!', '', 'Server error, please try again later');
              }
            }, function (err) {//this.loadingHide();
            });
          }
        }, {
          key: "getProductBid",
          value: function getProductBid(id) {
            var _this3 = this;

            // this.loadingShow();
            var formData = new FormData();
            formData.append('product_id', id);
            this.http.post(this.url + 'max-bid-by-product', formData).subscribe(function (res) {
              if (res.status) {
                // this.loadingHide();
                console.log(res); //this.product_deltail=res.response_data;
              } else {
                //this.loadingHide();
          ...
          value: function triggerModal(content) {
            ...
            this.modalService.open(content, {
              ...
              _this4.closeModal = "Closed with: ".concat(res);
            }, function (res) {
              _this4.closeModal = "Dismissed ".concat(_this4.getDismissReason(res));
            });
          }
        }, {
          ...
          key: "bidNow",
          value: function bidNow(c) {
            var _this5 = this;

            //console.log(c.id);
            var formData = new FormData(); //formData.append('id', '9');
            ...
            if (this.buyerId) {
              this.http.post(this.url + 'bid-add', formData).subscribe(function (res) {
                //this.res = res;
                console.log(res);
                ...
                if (res.status == true) {
                  ...
                  _this5.presentAlert('Success!', '', res.message); //this.dataList();
          ...
          key: "gotoauctionitem",
          value: function gotoauctionitem(id) {
            this.navCtrl.navigateForward('/auctionItems?idauctions=' + id);
          }
        }]);
    ...
    "LPU2":
    /*!*****************************************************************!*\
      !*** ./src/app/group-details/product-details-routing.module.ts ***!
      \*****************************************************************/

    /*! exports provided: ProductDetailsPageRoutingModule */

    /***/
    function LPU2(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    "RTUY":
    /*!*********************************************************!*\
      !*** ./src/app/group-details/product-details.module.ts ***!
      \*********************************************************/

    /*! exports provided: ProductDetailsPageModule */

    /***/
    function RTUY(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      var _product_details_routing_module__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
      /*! ./product-details-routing.module */
      "LPU2");
      /* harmony import */


      var _product_details_page__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
      /*! ./product-details.page */
      "5yP0");
      /* harmony import */
      ...
      ProductDetailsPageModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        imports: [_angular_common__WEBPACK_IMPORTED_MODULE_3__["CommonModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_4__["FormsModule"], _ionic_angular__WEBPACK_IMPORTED_MODULE_5__["IonicModule"], _product_details_routing_module__WEBPACK_IMPORTED_MODULE_6__["ProductDetailsPageRoutingModule"], _include_include_module__WEBPACK_IMPORTED_MODULE_8__["IncludeModule"], ngx_owl_carousel__WEBPACK_IMPORTED_MODULE_2__["OwlModule"]],
    ...
    "VHd7":
    /*!***********************************************************************************************!*\
      !*** ./node_modules/raw-loader/dist/cjs.js!./src/app/group-details/product-details.page.html ***!
      \***********************************************************************************************/

    /*! exports provided: default */

    /***/
    function VHd7(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_exports__["default"] = "<ion-content>\n  <app-header></app-header>\n\n  <section class=\"main_area product_details_area\">\n    <div class=\"container\">\n      <div class=\"row\">\n        <div class=\"col-lg-6\">\n\n          <div class=\"product_image_box\">\n\n\n            <div class=\"exzoom clearfix\" id=\"exzoom\">\n              <div class=\"exzoom_img_box\">\n                <ul class='exzoom_img_ul'>\n                  <!-- <li><img src=\"{{image_path + product_deltail?.product_picture}}\" /></li> -->\n                  <li><img src=\"assets/images/product-details1.png\" /></li>\n                 <!--  <li><img src=\"assets/images/product-details1.png\" /></li>\n                  <li><img src=\"assets/images/product-details1.png\" /></li> -->\n                </ul>\n              </div>\n              <div class=\"exzoom_nav\"></div>\n              <p class=\"exzoom_btn\">\n                <a href=\"javascript:void(0);\" class=\"exzoom_prev_btn\"><i class=\"fa fa-angle-up\"\n                    aria-hidden=\"true\"></i></a>\n                <a href=\"javascript:void(0);\" class=\"exzoom_next_btn\"><i class=\"fa fa-angle-down\"\n                    aria-hidden=\"true\"></i></a>\n              </p>\n            </div>\n\n          </div>\n\n        </div>\n        <div class=\"col-lg-6\">\n          <div class=\"product_details_contain\">\n            <div class=\"contain_box\">\n              <p id=\"demo2\"></p>\n\n              <h1>\n                {{product_deltail?.product_name}}\n                <strong>Auction ID : {{product_deltail?.auction_cg_number}}</strong>\n              </h1>\n            </div>\n            <div class=\"contain_box\">\n\n              <h3><strong>{{product_deltail?.category_group_name}}</strong></h3>\n              <h4><strong style=\"color: #0e0790\">This Auction closes in  : </strong> <strong id=\"demo\"></strong></h4>\n               <h4><strong>Items : {{itemTotal}}</strong></h4>\n                \n              <h4><strong>End Date & Time :</strong>{{product_deltail?.end_date | date:'MMM dd, yyyy'  + '     ' + product_deltail?.end_time}}  </h4>\n              <h4><strong>Location :</strong> {{product_deltail?.location}}</h4>\n            </div>\n            <div class=\"contain_box\">\n              <h5>highlights :</h5>\n              <p>{{product_deltail?.highlights}}\n              </p>\n              <a href=\"javascript:void(0);\" class=\"btn btn-primary\" (click)=\"gotoauctionitem(product_deltail?.id)\" >view items & bid <i class=\"zmdi zmdi-plus-circle\"></i></a>\n            </div>\n          </div>\n        </div>\n      \n\n        <div class=\"col-lg-12\">\n\n          <div class=\"product_description_area\">\n\n            <ul class=\"nav nav-tabs\">\n              <li class=\"nav-item\">\n                <a class=\"nav-link active\" data-toggle=\"tab\" href=\"#home\">description</a>\n              </li>\n              <li class=\"nav-item\">\n                <a class=\"nav-link\" data-toggle=\"tab\" href=\"#menu1\">acution terms</a>\n              </li>\n              <li class=\"nav-item\">\n                <a class=\"nav-link\" data-toggle=\"tab\" href=\"#menu2\">bid increment</a>\n              </li>\n            </ul>\n\n            <!-- Tab panes -->\n            <div class=\"tab-content\">\n              <div id=\"home\" class=\"tab-pane active\">\n                <div class=\"product_description\">\n                  {{product_deltail?.notes}}\n                </div>\n              </div>\n              <div id=\"menu1\" class=\"tab-pane fade\">\n                <div class=\"product_description\">\n                   {{product_deltail?.terms}}\n                </div>\n              </div>\n              <div id=\"menu2\" class=\"tab-pane fade\">\n                <div class=\"product_description\">\n                  <div class=\"description_box\">\n                    <div class=\"number\">1.</div>\n                    <h3><strong>Notes Information : </strong>THIS IS AN INTERNET ONLY AUCTION.</h3>\n                  </div>\n                  <div class=\"description_box\">\n                    <div class=\"number\">2.</div>\n                    <h3><strong>Auction Closing Date : </strong>The first 5 items will end at the ending time of the\n                      auction, then 5 items per minute thereafter until the last item in auction.</h3>\n                  </div>\n                  <div class=\"description_box\">\n                    <div class=\"number\">3.</div>\n                    <h3><strong>Inspection : </strong>Monday 4:00pm-6:00pm EST & Tuesday-Friday 1:00pm-6:00pm EST</h3>\n                  </div>\n                  <div class=\"description_box\">\n                    <div class=\"number\">4.</div>\n                    <h3><strong>Eligible Pickup Dates (All Pickup Times Are Local) :</strong></h3>\n                    <ul class=\"mt-2\">\n                      <li>March 9th, 2021 10:00 AM - 6:00 PM</li>\n                      <li>March 9th, 2021 10:00 AM - 6:00 PM</li>\n                      <li>March 9th, 2021 10:00 AM - 6:00 PM</li>\n                      <li>March 9th, 2021 10:00 AM - 6:00 PM</li>\n                    </ul>\n                  </div>\n                  <div class=\"description_box\">\n                    <div class=\"number\">5.</div>\n                    <h3><strong>Please Note : </strong>A valid, State or Federal issued ID is required to pick up all\n                      purchases. There are no refunds for items not picked up on time. If you cannot make the removal,\n                      you need to send someone on your behalf to pick up for you with their own ID and the printed\n                      invoice! *Be aware if the information of the person picking up does not match the information on\n                      the receipt, a phone call or text may be placed to you to verify the identity of the person\n                      picking up, or further credit card verification such as presentation of the card charged for large\n                      or multiple purchases. All forms of ID must be presented in person.</h3>\n                  </div>\n                  <div class=\"description_box\">\n                    <div class=\"number\">6.</div>\n                    <h3><strong>Pickup Location : </strong>Edwin Moses,835 Edwin C. Moses Boulevard,Dayton,OH,45417</h3>\n                  </div>\n                </div>\n              </div>\n            </div>\n\n          </div>\n\n        </div>\n\n      </div>\n    </div>\n  </section>\n  <!------- product details area stop -------->\n\n\n  <!----- product listing two area start ----->\n  <section class=\"main_area product_listing_area mt-0\">\n    <div class=\"container\">\n      <h2 class=\"h2 mb-2\"><strong>Related Auctions</strong></h2>\n      <owl-carousel [options]=\"carouselOptions\" [carouselClasses]=\"['product-carousel']\">\n        <div class=\"product\" *ngFor=\"let image of images;let i= index\">\n          <div class=\"product_box\">\n            <div class=\"image_box\">\n              <img src=\"{{image.image}}\" alt=\"product\" title=\"\" [routerLink]=\"['/product-details']\">\n            </div>\n            <div class=\"contain_box\">\n              <h4>Auction ID. BB31470</h4>\n              <a [routerLink]=\"['/product-details']\" routerLinkActive=\"active\" class=\"link\">OnePlus Band 1.1'' AMOLED Display</a>\n              <h3>Max Bid: $150.00</h3>\n              <button class=\"btn btn-bid\" [routerLink]=\"['/product-details']\">bid now <i class=\"zmdi zmdi-plus-circle\"></i></button>\n            </div>\n          </div>\n        </div>\n      </owl-carousel>\n    </div>\n  </section>\n\n  <app-footer></app-footer>\n</ion-content>";
      /***/
    },
...
//# sourceMappingURL=group-details-product-details-module-es5.js.map