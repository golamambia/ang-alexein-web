(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["pages-contact-us-contact-us-module"], {
    ...
    /***/
    function NA5(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function Pt6G(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function QCdY(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function vtAh(module, __webpack_exports__, __webpack_require__) {
      "use strict";
        ...
        _createClass(ContactUsPage, [{
          ...
          value: function setingsData() {
            ...
            this.http.post(this.url + 'get-setting-list', formData).subscribe(function (res) {
              //console.log(res);
              if (res && res.status) {
                _this.setData = res.response_data[0];
              } else {
                _this.setData = null;
              }
            });
