(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["admin-seller-subcategory-add-seller-subcategory-add-module"], {
    /***/
    "4X8Z":
    /*!*********************************************************************************************************************!*\
      !*** ./node_modules/raw-loader/dist/cjs.js!./src/app/admin/seller-subcategory-add/seller-subcategory-add.page.html ***!
      \*********************************************************************************************************************/
    ...
    "BF/n":
    /*!*******************************************************************************!*\
      !*** ./src/app/admin/seller-subcategory-add/seller-subcategory-add.page.scss ***!
      \*******************************************************************************/
    ...
    "BUwK":
    /*!***************************************************************************************!*\
      !*** ./src/app/admin/seller-subcategory-add/seller-subcategory-add-routing.module.ts ***!
      \***************************************************************************************/
    ...
    function BUwK(module, __webpack_exports__, __webpack_require__) {
      ...
      __webpack_require__.d(__webpack_exports__, "SellerSubcategoryAddPageRoutingModule", function () {
        return SellerSubcategoryAddPageRoutingModule;
      });
      /* harmony import */
      ...
      var _seller_subcategory_add_page__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
      /*! ./seller-subcategory-add.page */
      "CoCD");
      ...
      var SellerSubcategoryAddPageRoutingModule = function SellerSubcategoryAddPageRoutingModule() {
        _classCallCheck(this, SellerSubcategoryAddPageRoutingModule);
      };

      SellerSubcategoryAddPageRoutingModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
    ...
    "CoCD":
    /*!*****************************************************************************!*\
      !*** ./src/app/admin/seller-subcategory-add/seller-subcategory-add.page.ts ***!
      \*****************************************************************************/

    /*! exports provided: SellerSubcategoryAddPage */

    /***/
    function CoCD(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "SellerSubcategoryAddPage", function () {
        return SellerSubcategoryAddPage;
      });
      /* harmony import */
      ...
      var _raw_loader_seller_subcategory_add_page_html__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      /*! raw-loader!./seller-subcategory-add.page.html */
      "4X8Z");
      /* harmony import */


      var _seller_subcategory_add_page_scss__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
      /*! ./seller-subcategory-add.page.scss */
      "BF/n");
      /* harmony import */
      ...
      var SellerSubcategoryAddPage = /*#__PURE__*/function () {
        function SellerSubcategoryAddPage(alertController, http, formBuilder, loadingController) {
          _classCallCheck(this, SellerSubcategoryAddPage);
        ...
        _createClass(SellerSubcategoryAddPage, [{
          key: "ngOnInit",
          ...
          value: function submit() {
            ...
            if (this.categoryForm.invalid) {
              ...
              this.http.post(this.url + 'subcategory-add', formData).subscribe(function (res) {
                _this2.loadingHide();
                ...
                if (res.status) {
                  ...
                  _this2.presentAlert('Success!', '', res.message);
                } else {
      ...
      SellerSubcategoryAddPage.ctorParameters = function () {
        return [{
      ...
      SellerSubcategoryAddPage = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_3__["Component"])({
    ...
    "i6WZ":
    /*!*******************************************************************************!*\
      !*** ./src/app/admin/seller-subcategory-add/seller-subcategory-add.module.ts ***!
      \*******************************************************************************/

    /*! exports provided: SellerSubcategoryAddPageModule */

    /***/
    function i6WZ(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "SellerSubcategoryAddPageModule", function () {
        return SellerSubcategoryAddPageModule;
      });
      /* harmony import */
      ...
      var _seller_subcategory_add_routing_module__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
      /*! ./seller-subcategory-add-routing.module */
      "BUwK");
      /* harmony import */


      var _seller_subcategory_add_page__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
      /*! ./seller-subcategory-add.page */
      "CoCD");

      var SellerSubcategoryAddPageModule = function SellerSubcategoryAddPageModule() {
        _classCallCheck(this, SellerSubcategoryAddPageModule);
      };

      SellerSubcategoryAddPageModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        imports: [_angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormsModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["ReactiveFormsModule"], _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["IonicModule"], _seller_subcategory_add_routing_module__WEBPACK_IMPORTED_MODULE_5__["SellerSubcategoryAddPageRoutingModule"]],
...
//# sourceMappingURL=admin-seller-subcategory-add-seller-subcategory-add-module-es5.js.map