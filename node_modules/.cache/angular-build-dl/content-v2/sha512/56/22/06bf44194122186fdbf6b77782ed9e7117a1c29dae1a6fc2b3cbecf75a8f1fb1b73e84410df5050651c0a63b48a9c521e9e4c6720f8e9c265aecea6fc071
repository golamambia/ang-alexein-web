(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["admin-admin-login-admin-login-module"], {
    ...
    /***/
    function Pd7(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function Fbmq(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function LiIn(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "AdminLoginPageModule", function () {
      ...
      var _admin_login_routing_module__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
      /*! ./admin-login-routing.module */
      "/Pd7");
      /* harmony import */


      var _admin_login_page__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
      /*! ./admin-login.page */
      "ynWH");

      var AdminLoginPageModule = function AdminLoginPageModule() {
        _classCallCheck(this, AdminLoginPageModule);
      };

      AdminLoginPageModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        imports: [_angular_common__WEBPACK_IMPORTED_MODULE_3__["CommonModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_4__["FormsModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_4__["ReactiveFormsModule"], _ionic_angular__WEBPACK_IMPORTED_MODULE_5__["IonicModule"], _admin_login_routing_module__WEBPACK_IMPORTED_MODULE_6__["AdminLoginPageRoutingModule"], src_app_include_include_module__WEBPACK_IMPORTED_MODULE_2__["IncludeModule"]],
    ...
    /***/
    function bbVK(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function ynWH(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      var _raw_loader_admin_login_page_html__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      /*! raw-loader!./admin-login.page.html */
      "bbVK");
      /* harmony import */


      var _admin_login_page_scss__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
      ...
      var AdminLoginPage = /*#__PURE__*/function () {
        function AdminLoginPage(storage, router, loadingController, http, formBuilder, alertController) {
              ...
              this.http.post(this.url + 'user-login', formData).subscribe(function (res) {
                if (res && res.status) {
                  if (res.response_data.role_text == 'Admin') {
                    _this2.storage.set('auctionAdmin', res).then(function (response) {
                      _this2.loadingHide();

                      _this2.router.navigate(['/admin/dashboard']);
                    });
                  } else {
                    _this2.loadingHide();
      ...
      AdminLoginPage = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_4__["Component"])({
...
//# sourceMappingURL=admin-admin-login-admin-login-module-es5.js.map